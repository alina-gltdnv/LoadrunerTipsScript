# 1 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
lr_end_sub_transaction("1_Start", 2);


return 0;
}
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
lr_start_sub_transaction("2_City", "Common");
	...
	"Name=__VIEWSTATEGENERATOR", "Value={VIEWSTATEGEN}", "ENDITEM",
	"Name=__EVENTVALIDATION", "Value={EVENTVAL}", "ENDITEM",
	"Name={CNAME}", "Value=Alwar", "ENDITEM",  
	"Name=ctl00$head$btnNext", "Value=Next", "ENDITEM",
	"LAST");

lr_end_sub_transaction("2_City", 2);

return 0;
}
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
lr_end_sub_transaction("3_Numbers", 2);
...
lr_start_sub_transaction("4_LastPage", "Common");
	...
	"Mode=HTML",
	"LAST");
lr_end_sub_transaction("4_LastPage", 2);
lr_end_transaction("Common", 2);

return 0;
}
# 7 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
...
# 8 "c:\\users\\user\\documents\\vugen\\scripts\\loadruner_tips\\\\combined_loadruner_tips.c" 2
